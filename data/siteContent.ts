...
export const siteContent = {
  ...
  footer: {
    ...
    servicesLinks: [
      ...
      { label: "Birthdays", href: "/#portfolio" },
      { label: "Baptism", href: "/#portfolio" },
      { label: "Corporate", href: "/#portfolio" },
      { label: "Institutional", href: "/#portfolio" },
      { label: "Public Events", href: "/#portfolio" },
      { label: "Brand Activations", href: "/#portfolio" },
      { label: "Customised Décor", href: "/#customised-decor" },
    ],
    exploreLinks: [
